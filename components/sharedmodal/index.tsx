  ...
  return (
    ...
    >
      <div className="relative z-50 flex flex-col gap-4 justify-self-center">
            ...
            <div className="absolute inset-0 mx-auto flex max-w-5xl items-center justify-center">
              <div className="relative aspect-[3/2] max-h-full w-full">
                {index > 0 && (
                  <button
                  type="button"
                    className="absolute left-3 top-[50%] -translate-y-1/2 z-50"
                ...
                {index + 1 < images.length && (
                  <button
                  type="button"
                    className="absolute right-3 top-[50%] -translate-y-1/2 z-50"
                    onClick={() => changePhotoId(index + 1)}
                  >
        ...
        {/* Thumbnail gallery */}
        <div className="relative overflow-hidden bg-black/80 backdrop-blur-lg rounded-lg w-full max-w-5xl">
          <div className="flex gap-1 overflow-x-auto px-2 py-2 scrollbar-hide">
            {images.map((image, i) => (
              <button
                ...
                className={cn(
                  'relative flex-none h-20 overflow-hidden rounded-md',
